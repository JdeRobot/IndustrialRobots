...
def generate_launch_description():
    ...
    if (EE == "false"):
        ...
        robot_description_semantic_config = load_file(PACKAGE_NAME + "_moveit2", "config/" + CONFIGURATION["rob"] + CONFIGURATION["ee"] + "_yamaha"+ ".srdf")
    ...
    if (EE == "false") or (EE == "true-NOctr"):
        joint_limits_yaml = load_yaml("ros2srrc_robots", CONFIGURATION["rob"] + "/config/joint_limits_yamaha.yaml")
    else:
        YAML_ROB = load_yaml("ros2srrc_robots", CONFIGURATION["rob"] + "/config/joint_limits_yamaha.yaml")["joint_limits"]
