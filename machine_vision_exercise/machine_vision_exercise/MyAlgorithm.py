...
try:
    from HAL import (MoveAbsJ, MoveLinear, MoveJoint, MoveRelLinear, 
                     ...
                     back_to_home, set_home_position,_get_perception_manager)
...
def main():
    ...
    # ===== Your test =====
    perception = _get_perception_manager()
    ...
    length, width, diameter, shape, color = get_object_info(object_name)
...
#################################################################################################################
    ...
    object_pos = get_object_position(object_name)
